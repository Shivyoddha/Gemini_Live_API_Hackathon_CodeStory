...
# Paths: support both (a) server inside react-demo-app/ and (b) server at repo root
_SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
if os.path.isdir(os.path.join(_SCRIPT_DIR, "combined_workflow_sent")):
    WORKSPACE_ROOT = _SCRIPT_DIR  # repo root
else:
    WORKSPACE_ROOT = os.path.dirname(_SCRIPT_DIR)  # parent (e.g. streaming_app)
