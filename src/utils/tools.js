...
export class SwitchSlideTool extends FunctionCallDefinition {
  constructor(onSwitch) {
    super(
      "switch_slide",
      "Navigate to a specific slide in a module. Call this when the user confirms they are ready to move to the next slide, or when a specific slide is directly relevant to a question. IMPORTANT: After calling this tool, do NOT say anything — remain completely silent. The system will automatically handle the slide transition and narration.",
      {
        type: "object",
        properties: {
          module: {
